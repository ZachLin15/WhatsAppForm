...
logging.basicConfig(filename=r'C:\Users\USER\ImportOracle\pythonProject1\Log\Simplr_WS3_Import.log',level=logging.INFO,
...
def Output(sheet,combine_df):
    ...
    url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vS83x3wHRg4KaWe8nVVn3Qds5W0iGDERFDiKcyR15VFeEbXJwMJ-PpFtND7BbuYqw4VQYHXyJBJ-sWh/pub?output=xlsx"
    response = requests.get(url)

    exceldata = r"C:\Users\USER\ImportOracle\pythonProject1\dist\data3.xlsx"
    ...
    data["po_no"] = data.apply(
        lambda row: row["po_no"] + "-F" if row["supplier_item_code"].startswith(
            ("FR", "ZF", "FSI", "FF", "ZKF", "RMFR", "CH","RMV")) else row["po_no"] + "-D",
        axis=1)
...
def Export_Query(file_path,receiver_email):
        ...
        for _ in tqdm(range(25), desc="Importing", unit="s"):
            time.sleep(1)
...
if __name__ == '__main__':
    ...
    form = ['The Food Theory Group (DAXI) Or',
'The Food Theory Group (Josh Gri',
'Xprienz Pte Ltd Order Form',
'Triple J Food Works Order Form',
'The Soul Kitchen by Big D Order',
'15 Five Pte Ltd Order Form',
'Fun Toast Pte Ltd Order Form',
'Rokus A.G.B. Pte Ltd. Order For',
'The Ship Restaurant & Bar Order',
'Aston Food & Beverage (The Ranc',
'Aston Food & Beverage (BIZEN) O',
'Vismark Food Industries Order F',
'Hooters Order Form',
'Daruma Tavern Order Form',
'Gourmetz Pte Ltd Order Form',
'Singapore Fast Food PL Order Fo',
'Pizza Arc Pte Ltd Order Form',
'Eatz Catering Services Order Fo',
'TC HOSPITALITY Order Form',
'FM Food Court Order Form',
'Jackson Bakery & Confectionery ',
'Antonio Ordering Form',
'Fifty Year Order Form',
'Tana Development Order Form',
'Food Republic Ordering Form',
'BREWERKZ Order Form',
'Hungry BoyGotoEat Order Form',
'Orchard Grand Court Order Form',
'Min Investments Order Form',
'Shokudo Concepts Order Form',
'Bighouse Pte Ltd Order Form',
'Hong Kaolin Liao Li Order Form',
'United Bakery Supplies Order Fo',
'Four Leaves Order Form',
'Sincere Culinary Development Or',
'The Carving Board Order Form',
'Homies Bakery Order Form',
'Konditori Order Form',
'Liquid Chocolate Order Form',
'YL Food Ventures LLP Ordering F',
'Wheelers Estate Order Form',
'Garden Pastry &amp; Cake Order ',
'Super Tea (S) Order Form',
'Tash Tish Tosh (S) Order Form',
'Muyoo Order Form',
'Hansfort Order Form',
'Long Beach Order Form',
'The Ivy Order Form',
'ARCADE FISH SOUP Order Form',
'Lucky Cafes Order Form',
'Cafe De Muse Order Form',
'Yue Fan Order Form',
'Bosses Restaurant Order Form',
'Fatboys Concepts Order Form',
'Hajime Order Form',
'Tolido Enterprise Order Form',
'Teppan Master Order Form',
]
