...
logging.basicConfig(filename=r'C:\Users\USER\ImportOracle\pythonProject1\Log\Simplr_WS1_Import.log',level=logging.INFO,
...
exceldata = r"C:\Users\USER\ImportOracle\pythonProject1\dist\data.xlsx"


def Output(sheet,combine_df):
    # Download the Excel file from Google Sheets
    url = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQB95o_8ge8NmIJaxYmr8TNBqaH-RDjl-dWVYVrHXRXuGAiDhSmbNN9yAr2gvwcXMyAu4haWZFfnvzS/pub?output=xlsx"
    ...
    data["po_no"] = data.apply(
        lambda row: row["po_no"] + "-F" if row["supplier_item_code"].startswith(
            ("FR", "ZF", "FSI", "ZKF", "CH", "RMFR", "FF","RMVE","UN","JOFRBT")) else row[
                                                                     "po_no"] + "-D",
        axis=1)
...
if __name__ == '__main__':
    ...
    """"form = ["Newgen Food Order Form", "KOLO MEE 219 Order Form", "Yes Tomato Order Form", "Refuel Group Order Form",
            "The Chefs place Order Form", "The Golden Whale International ", "Spice Village Catering Order Fo",
            "Tobys The Dessert Asylum Order ","Luna Patisserie Order Form " ,"Cask and Bangers Order Form",
            "Grain Order Form","Creative Food Concept Order For", "LNS Foods Order Form","East Winds Food Order Form",
            "On & On Diners Order Form", "Lim Soon Poh Trading Order Form", "Create Restaurants Asia Order F",
            "Munch Works LLP Order Form",
            "Chops & Sear Order Form","Hot Tomato Order Form", "Poon Resources Order Form", "LSH-219 Order Form (1)", " AUNTIE ANNES Order Form"]"""
